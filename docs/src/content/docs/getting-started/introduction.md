---
title: Introduction
description: Overview of Playify.
---
...
Playify has been completely rewritten in V2 to provide a seamless, robust, and beautiful experience directly from your terminal.
